<p style="font-size:small;">(This site is in draft mode. We are working to solidify the best possible language/framing, format it nicely, include meaningful graphics, provide links to sources, etc. However, even in this unfinished state, it gives you the gist of where our heads are. We will finalize this site before we submit the petition to admin. Feedback/Concerns? <a href="https://forms.gle/rkFJRXGZBkviyj517">Write us an anonymous note</a> and we'll talk about it in our next meeting.)</p>
