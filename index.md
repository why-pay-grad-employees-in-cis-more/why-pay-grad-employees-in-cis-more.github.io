<sub>*(This site is in draft mode. We are working to solidify the best possible language/framing, format it nicely, include meaningful graphics, provide links to sources, etc. However, even in this unfinished state, it gives you the gist of where our heads are. We will finalize this site before we submit the petition to admin. Questions? Contact Sam Schwartz at sam@cs.uoregon.edu)*</sub>
